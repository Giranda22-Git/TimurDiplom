<template>
  <div class="wrapper" id="PayMent">
    <div class="infoBlock">
      <div class="heading">
        <span> Я искренне верю </span> в то, что у каждого человека есть право <br>
        на счастливую жизнь, свободное от нужды и болезней.
      </div>
      <div class="text">
        Благодаря вам я смогу получать поддержку которая мне так нужна, ведь я не хочу испытывать нужду в <br> базовых потребностях человека и из-за этого чувствовать дискомфорт. <br> Всё начинается с доброго намерения! Всё начинается с нас!
      </div>
